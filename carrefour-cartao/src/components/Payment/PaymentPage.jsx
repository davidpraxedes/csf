    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-6 md:py-8">
        ...
        >
          ...
          <div className="bg-blue-50 border-l-4 border-carrefour-blue rounded-xl p-4 sm:p-5 md:p-6 mb-6 md:mb-8">
            <div className="flex items-start gap-3 sm:gap-4">
              <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-carrefour-blue flex-shrink-0 mt-0.5 sm:mt-1" />
              <div>
                <p className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">O que está incluído:</p>
                <ul className="space-y-1.5 text-xs sm:text-sm text-gray-700">
                  <li className="flex items-start gap-2">
                    <span className="text-carrefour-blue mt-1">•</span>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-4 sm:p-6 md:p-8 mb-4 md:mb-6">
                <div className="text-center mb-4">
                  ...
                  <div className="flex items-center justify-center gap-2 text-sm text-gray-600 mb-2">
                    ...
                    <span className="font-semibold text-carrefour-blue">R$ {(valorEntrega || 25.50).toFixed(2).replace('.', ',')}</span>
                  </div>
                </div>
                
                <div className="bg-gray-50 rounded-xl p-3 sm:p-4 md:p-5 mb-3 md:mb-4 border-2 border-carrefour-blue/20">
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 mb-4 md:mb-6 overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-3">
                    <CreditCard className="w-5 h-5 sm:w-6 sm:h-6 text-carrefour-blue" />
                ...
                {qrCodeExpandido && (
                  ...
                  >
                    <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl flex justify-center border-2 border-carrefour-blue/20">
          ...
          <div className="bg-blue-50 border-l-4 border-carrefour-blue rounded-xl p-4 sm:p-5 md:p-6 mb-4 md:mb-6">
            <div className="flex items-start gap-3 sm:gap-4">
              <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-carrefour-blue flex-shrink-0 mt-0.5 sm:mt-1" />
              <div>
                <p className="font-semibold text-gray-900 mb-1 sm:mb-2 text-sm sm:text-base">Ativação Imediata</p>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-carrefour-blue hover:bg-blue-700 text-white font-semibold text-base sm:text-lg py-4 sm:py-5 px-4 sm:px-6 md:px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 sm:gap-3"
            >
              Finalizar Ativação
