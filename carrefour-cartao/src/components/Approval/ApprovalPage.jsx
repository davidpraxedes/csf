...
export default function ApprovalPage() {
  ...
  const limite = limiteStore && limiteStore !== '2.500,00' ? limiteStore : '5.500,00';
  
  // Se o limite estiver com valor antigo, atualizar
  useEffect(() => {
    if (limiteStore === '2.500,00' || !limiteStore) {
      setLimite('5.500,00');
    }
  }, [limiteStore, setLimite]);
